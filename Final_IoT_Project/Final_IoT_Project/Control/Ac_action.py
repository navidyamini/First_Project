...
from subscribe_data_DHT import Subscribe_data_DHT
...
if __name__ == '__main__':
    ...
    try:
        client_temp.on_subscribe = Subscribe_data_DHT.on_subscribe
        client_temp.on_message = Subscribe_data_DHT.on_message
