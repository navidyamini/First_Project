                                        ...
                                        <ul class="nav side-menu">
                                          <li><a><i class="fa fa-home"></i> Rooms <span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu">
                                              <li><a href="/static/production/indexXimevs1">Room 1</a></li>
                                ...
                                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                                  <div class="menu_section">
                                    ...
                                    <ul class="nav side-menu">
                                      <li><a><i class="fa fa-home"></i> Rooms <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                          <li><a href="/static/production/indexXimevs1.html">Room 1</a></li>
                                          <li><a href="/static/production/index2.html">Room 2</a></li>
                                          <li><a href="/static/production/index3.html">Room 3</a></li>
                                        </ul>
                                      </li>
...
if __name__ == "__main__":
    conf = {
        ...
        '/static': {
            ...
            'tools.staticdir.dir': os.path.join (os.getcwd ( ), "RawWebpage")        }
    }
