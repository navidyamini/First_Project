...
class MuseumsWP (object):
    ...
    def GET(self, *uri, **params):
        ...
        inidata = requests.get(url).content
        ...
        if uri[0] == "index" :
            ...
            return (str (inidata["thresholds"]["max_temp"]))
        elif (uri[0] == "minTemp"):
            return (str (inidata["thresholds"]["min_temp"]))
        elif (uri[0] == "maxHum"):
            return (str (inidata["thresholds"]["max_hum"]))
        elif (uri[0] == "minHum"):
            return (str (inidata["thresholds"]["min_hum"]))
        elif (uri[0] == "readAPIkey"):
            return (str(inidata["thingspeak"]["READ_API_KEY"]))
        elif (uri[0] == "accToken"):
            return (str(inidata["thingspeak"]["ACCESS_TOKEN"]))
        elif (uri[0] == "tTrans"):
            return (str(inidata["thingspeak"]["tTransport"]))
        elif (uri[0] == "chanID"):
            return (str(inidata["thingspeak"]["channelID"]))
        elif (uri[0] == "tPort"):
            return (str(inidata["thingspeak"]["tPort"]))
        elif (uri[0] == "mqttHost"):
            return (str(inidata["thingspeak"]["mqttHost"]))
        elif (uri[0] == "thingHost"):
            return (str(inidata["thingspeak"]["THINGSPEAK_HOST"]))
        elif (uri[0] == "brokerIP"):
            return (str(inidata["broker"]["Broker_IP"]))
        elif (uri[0] == "brokerPort"):
            return (str(inidata["broker"]["Broker_port"]))
        elif (uri[0] == "acTop"):
            return (str(inidata["broker"]["AC_Topic"]))
        elif (uri[0] == "dhtTop"):
            return (str(inidata["broker"]["DHT_Topic"]))
        elif (uri[0] == "counTop"):
            return (str(inidata["broker"]["Counter_Topic"]))
        elif (uri[0] == "telegPort"):
            return (str(inidata["telegram"]["Port"]))
        elif (uri[0] == "telegChatid"):
            return (str(inidata["telegram"]["chatID"]))
        elif (uri[0] == "dash1"):
